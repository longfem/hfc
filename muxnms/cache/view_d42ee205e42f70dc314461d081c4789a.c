...
static void view_d42ee205e42f70dc314461d081c4789a(HttpConn *conn) {
...
ESP_EXPORT int esp_view_d42ee205e42f70dc314461d081c4789a(HttpRoute *route, MprModule *module) {
   espDefineView(route, "client/login.esp", view_d42ee205e42f70dc314461d081c4789a);
   return 0;
}
